...
function swc(options = {}) {
    ...
    return {
        ...
        async transform (code, id) {
            ...
            const { filename: _1 , include: _2 , exclude: _3 , tsconfig: _4 , minify: _5 , ...restSwcOptions } = options;
